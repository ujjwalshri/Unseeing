          ...
          {!isLoading && user && !isRefetching && (
            <>
              ...
              <div className="relative group/cover">
                ...
                {isMyProfile && (
                  <div
                    className="absolute top-2 right-2 rounded-full p-2 bg-gray-800 bg-opacity-75 cursor-pointer opacity-0  transition duration-200"
                ...
                <div className="avatar absolute -bottom-16 left-4">
                  <div className="w-32 rounded-full relative group/avatar">
                    ...
                    />
                    <div className="absolute top-5 right-3 p-1 bg-primary rounded-full  opacity-0 cursor-pointer">
                      {isMyProfile && (
                        <MdEdit
